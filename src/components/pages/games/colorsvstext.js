...
import tutImage from '../../../assets/Instructions/colorsvstext.png';
...
class colorsvstext extends Component {
    componentDidMount() {
        window.scrollTo(0, 0)
    }
    render() {
        const unityContent = new UnityContent(
            "./games/colorsvstext/Build/ColorsVsText.json",
            "./games/colorsvstext/Build/UnityLoader.js"
          );
        return (
            <Style>
            <div>
...
export const OtherReflexGamesco = () => (
    <CardStyle>
