...
import tutImage from '../../../assets/Instructions/rememberold.png';
...
class rememberold extends Component {
    componentDidMount() {
        window.scrollTo(0, 0)
    }
    render() {
        const unityContent = new UnityContent(
            "./games/rememberold/Build/RememberOld.json",
            "./games/rememberold/Build/UnityLoader.js"
          );
        return (
            <Style>
            <div>
...
export const OtherMemoryGamesOld = () => (
    <CardStyle>
