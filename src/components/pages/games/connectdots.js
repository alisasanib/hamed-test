...
import tutImage from '../../../assets/Instructions/connectdots.png';
...
class connectdots extends Component {
    componentDidMount() {
        window.scrollTo(0, 0)
    }
    render() {
        const unityContent = new UnityContent(
            "./games/connectdots/Build/ConnectDots.json",
            "./games/connectdots/Build/UnityLoader.js"
          );
        return (
            <Style>
            <div>
...
export const OtherReflexGamesconn = () => (
    <CardStyle>
